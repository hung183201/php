...
>
  ...
  >
    <div
      class="common__category-description box-med bp-curve3 bg-ash2 text-center has-tab" style="background-image: url('images/shutterstock_1479130211_huge.jpg');background-position: center;background-size: cover;background-repeat: no-repeat ;"
    >
      <h3 class="no-margin thesans">Chính sách</h3>
    </div>
  </div>
  <!-- Component End -->
...
<div class="section animated fadeInUp" style="animation-delay: 0s">
  <div class="module container bp-width-med3"></div>
  <div class="module container bp-width-med3"></div>
</div>
@endsection